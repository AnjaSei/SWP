...
function toggle(source) {
  box1 = document.getElementsByName('foo1');
	box1.checked = source.checked;
  box2 = document.getElementsByName('foo2');
box2.checked = source.checked;
  box3 = document.getElementsByName('foo3');
	box3.checked = source.checked;
  box4 = document.getElementsByName('foo4');
box4.checked = source.checked;
