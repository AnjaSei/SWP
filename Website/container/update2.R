...
if (!dir.exists(args[2])){
  ...
  dir.create(path=paste0(args[2],"/venn_diagrams/"), recursive=TRUE)
}
...
my_table<- function(norm_data, outputname){
  ...
  write.table(summary, row.names=FALSE, file=paste0(args[2], "/", outputname, ".txt"), sep="\t", dec=",")
  write.csv(summary, row.names=FALSE, file=paste0(args[2], "/", outputname,".csv") )
  return(summary);
}
...
top_genes<-function(rma_table, mas5_table, top_number){
  ...
  for (i in 23:25){
    ...
    venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n",colnames(rma_table)[i]), main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_", colnames(rma_table)[i],".png"), imagetype="png")
	    write.table(top, row.names=FALSE, file=paste0(args[2],"/top_50_",colnames(rma_table)[i],".txt"), dec=",", sep="\t" )
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n p_value SLR FC"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_123", colnames(rma_table)[i],".png"), imagetype="png")
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n p_value FC SLR"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_132", colnames(rma_table)[i],".png"), imagetype="png")
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n SLR p_value FC"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_213", colnames(rma_table)[i],".png"), imagetype="png")
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n SLR FC p_value"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_231", colnames(rma_table)[i],".png"), imagetype="png")
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n FC p_value FC"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_312", colnames(rma_table)[i],".png"), imagetype="png")
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n FC SLR p_value"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/venn_diagrams/venn_diagram_321", colnames(rma_table)[i],".png"), imagetype="png")
}
...
#select top 50 genes and create venn diagramms
...
write.table(cbind(rownames(mas5_calls), mas5_calls), row.names=FALSE, file=paste0(args[2], "/pre_abs_calls.txt"), sep="\t", dec=",")
