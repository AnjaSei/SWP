...
top_genes<-function(rma_table, mas5_table, top_number){
  ...
  venn.diagram(list("RMA"=top[,1], "MAS5"=top[,2]), main=paste0("Overlap of differentially expressed genes\n FC SLR p_value"),main.cex=2, cat.cex=1.5, cat.pos=c(0,0), fill=c("darkgreen", "blue"), cex=1.5, filename=paste0(args[2],"/ven_diagrams/venn_diagram_321", colnames(rma_table)[i],".png"), imagetype="png")
}
